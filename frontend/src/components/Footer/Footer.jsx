...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#EF4444] text-white py-8 mt-24 bottom-0 w-full">
      <Container>
        <Grid
          container
          direction="row"
        ...
        >
          ...
          >
            ...
            <Typography variant="body2">Get free home delivery</Typography>
          </Grid>
          ...
          >
            ...
            <Typography gutterBottom>Islamabad, Pakistan</Typography>
            <Typography variant="body2">felineconnect@gmail.com</Typography>
          ...
          >
            ...
            <Typography variant="body2" gutterBottom className="text-gray-500 ">
              Get your app from below given links
            </Typography>
      ...
      <Typography variant="body2" className=" text-center text-white">
        © Copyright fyp 2025. All rights reserved
      </Typography>
      {/* <Snackbar
